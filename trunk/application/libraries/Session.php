...
class CI_Session {
	...
	function CI_Session($security_code="LeouOeEkKpvSnD-YCHd5ogt89y")
	{
		$this->object =& get_instance();
		log_message('debug', "Native_session Class Initialized");
		$this->_sess_run();
		$this->security_code = $security_code;
		$this->fingerprint = $this->_generate_fingerprint();
	}
    ...
    */
	...
	function _generate_fingerprint()
	{
		...
		$list = array('HTTP_ACCEPT_CHARSET',
									...
									'HTTP_USER_AGENT');
		$key = array($this->security_code);
		foreach($list as $item) 
			{
			$key[] = $this->object->input->server($item);
			}
